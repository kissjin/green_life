...
import 'package:green_life/res/styles.dart';
import 'package:green_life/res/colors.dart';
import 'package:green_life/res/dimens.dart';
import 'package:green_life/utils/theme_utils.dart';
import 'package:green_life/ui/pie_chart/pie_data.dart';
            ...
            child: ExcludeSemantics(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  // Gaps.vGap4,
                  Text('$count',style: TextStyle(fontSize: 22,fontWeight: FontWeight.w600),)
                ],
              ),
            ),
          )
...
//      print(data[i].toString());
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _mPaint..color = bgColor
      ..style = PaintingStyle.fill;
    canvas.drawCircle(offset, mRadius * 0.6, _mPaint);
