...
class Gaps {
  ...
  static Widget vLine(double h) {
    return Container(height: h, color: Color(0xFFEEEEEE));
  }
...
class TextStyles {
  ...
  static TextStyle addressStyle = TextStyle(color: Color.fromRGBO(51, 51, 51, 1),
      ...
      fontSize: 16);
  //切换地址栏文字style
  static TextStyle changeAddressStyle = TextStyle(color: Color.fromRGBO(154, 128, 71, 1),
      fontWeight: FontWeight.bold,
      fontSize: 18
  );
  //订单详情文字style
  static TextStyle orderDetailStyle = TextStyle(color: Color.fromRGBO(217, 58, 31, 1),
      fontWeight: FontWeight.bold,
      fontSize: 18);

  //订单详情底部文字style
  static TextStyle orderBottomStyle = TextStyle(color: Color.fromRGBO(255, 255, 255, 1),
      fontWeight: FontWeight.bold,
      fontSize: 18);
}
