...
const String z = 'z';
const String Z = 'Z';
String formatDateByYMDHMS(int microseconds) {
  return formatDate(DateTime.fromMillisecondsSinceEpoch(microseconds),
      formats: [yyyy, '-', mm, '-', dd, ' ', HH, ':', nn, ':', ss]);
}
String formatDateByYMDHM(int microseconds) {
  return formatDate(DateTime.fromMillisecondsSinceEpoch(microseconds),
      formats: [yyyy, '-', mm, '-', dd, ' ', HH, ':', nn]);
}
String formatDateByYMD(int microseconds) {
  return formatDate(DateTime.fromMillisecondsSinceEpoch(microseconds),
      formats: [yyyy, '-', mm, '-', dd]);
}
String formatDateByHM(int microseconds) {
  return formatDate(DateTime.fromMillisecondsSinceEpoch(microseconds),
      formats: [HH, ':', nn]);
}
...
String formatDateByYMDEH(int microseconds, {List<String> formats}) {
  return formatDate(DateTime.fromMillisecondsSinceEpoch(microseconds),
      formats: [yyyy, '-', mm, '-', dd,' ',EE_ZH]);
}
String formatDateByStr(String datetimeStr, {List<String> formats}) {
  if(datetimeStr==null || datetimeStr=="") return '';
  return formatDate(DateTime.parse(datetimeStr), formats: formats ?? [yyyy, '-', mm, '-', dd, ' ', HH, ':', nn, ':', ss]);
}
